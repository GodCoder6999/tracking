<x-layouts.app heading="New Client">
    <form method="POST" action="{{ route('dealer.clients.store') }}" class="card space-y-4 max-w-2xl">
        @csrf
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div><label class="block text-sm font-medium mb-1">Password (client login)</label><input type="password" name="password" class="input" required></div>
