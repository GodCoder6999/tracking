<x-layouts.app heading="Import Clients">

    <div class="flex items-center gap-3">
        <a href="{{ route('dealer.clients.index') }}" class="btn-secondary">← Back to Clients</a>
        <a href="{{ route('dealer.clients.create') }}" class="btn-secondary">+ Add Manually</a>
    </div>

    <div class="card">
        <h2 class="font-semibold mb-1">Bulk Import Clients</h2>
        ...
        <div class="mb-5 space-y-4 text-xs text-slate-600">
            <div>
                ...
                <ol class="list-decimal list-inside space-y-1">
                    ...
                    <li>Add one client per line below, values separated by commas:<br>
                        <code class="bg-slate-100 px-1 py-0.5 rounded font-mono">Jane Smith,jane@example.com,9123456780,Delhi,Secret@123</code>
                    </li>
                    <li>Save with a <strong>.csv</strong> extension (e.g. <code class="font-mono">clients.csv</code>) and upload.</li>
                </ol>
  ...
  {"name":"Jane Smith","email":"jane@example.com","phone":"9123456780","address":"Delhi","password":"Secret@123"},
  {"name":"Ravi Kumar","email":"ravi@example.com","phone":"9876500001","address":"Chennai","password":""}
]</pre>
        ...
        <form method="POST" action="{{ route('dealer.clients.import.store') }}" enctype="multipart/form-data" class="flex flex-wrap gap-3 items-end">
            @csrf
    ...
    @isset($created)
    <div class="card">
        <h3 class="font-semibold mb-3 text-green-700">✓ {{ count($created) }} client(s) created</h3>
        @if (count($created))
