...
<a href="{{ route('owner.dashboard') }}" class="nav-item {{ $active('owner.dashboard') }}">
...
<a href="{{ route('owner.dealers.index') }}" class="nav-item {{ $active('owner.dealers.*') }}">
    <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
...
<a href="{{ route('owner.orders.index') }}" class="nav-item {{ $active('owner.orders.*') }}">
    <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
...
<a href="{{ route('owner.analytics') }}" class="nav-item {{ $active('owner.analytics') }}">
    <svg class="w-4 h-4 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.75">
